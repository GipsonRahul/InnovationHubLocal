...
webURL = "https://chandrudemo.sharepoint.com/sites/GGSA_Production";
WeblistURL = "Annual Plan Test";
playbookURL =
  "https://chandrudemo.sharepoint.com/sites/GGSA_Production/SitePages/Playbook.aspx?activityID=";
