...
const OrgApprovalRequests = (props: IProps): JSX.Element => {
  ...
  // const currentLoggedUserEmail: string = "bdenigan@goodtogreatschools.org.au";
  ...
  const getOrgReportData = (): void => {
    ...
    sharepointWeb.lists
      ...
      .filter(
        // `UserId eq ${currentLoggedUserID} and Year eq ${OR_Year} and GroupID eq 1`
        `UserId eq ${currentLoggedUserID} and Inactive ne 1`
      )
      .orderBy("ID", true)
      .top(5000)
      .get()
