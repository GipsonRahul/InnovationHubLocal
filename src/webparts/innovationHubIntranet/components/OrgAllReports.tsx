          ...
          onRender: (item: IData) => (
            <div style={{ display: "flex" }}>
              ...
              >
                <Icon
                  iconName="Edit"
                  className={ORiconStyleClass.editIcon}
                  onClick={(): void => {
                    let targetObj: INewData = {
                      ID: item.ID,
              ...
              >
                <Icon
                  iconName="Delete"
                  className={ORiconStyleClass.deleteIcon}
                  onClick={(): void => {
                    setORDeletePopup({ condition: true, targetID: item.ID });
                  }}
                />
              </div>
            </div>
            ...
            {ORHistoryData.length > 0 ? (
              ...
              >
                <Pagination
                  ...
                  totalPages={
                    ORHistoryData.length > 0
                      ? Math.ceil(ORHistoryData.length / totalPageItems)
                      : 1
                  }
                  onChange={(page) => {
                    paginateFunction(page, ORHistoryData);
                  }}
                />
              </div>
            ) : (
              ...
              >
                ...
                >
                  ...
                  {props.isAdmin ? (
                    <PrimaryButton
                      text="Add"
                      className={styles.orgExportButton}
                      onClick={(_) => {
                        setORAddConfigModalBox({
                          type: "add",
                          visible: true,
